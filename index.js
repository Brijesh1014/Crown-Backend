...
const instagramFeedRoute = require("./src/instagramFeed/instagramFeed.route")
const facebookFeedRoute = require("./src/facebookFeed/facebookFeed.route")
...
app.use("/api/instagram", instagramFeedRoute);
app.use("/api/facebook", facebookFeedRoute);
